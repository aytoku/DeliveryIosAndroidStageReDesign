...
class ChatScreenOldVersion extends StatefulWidget {
  String order_uuid;

  ChatScreenOldVersion({Key key, this.order_uuid}) : super(key: key);

  @override
  ChatScreenOldVersionState createState() {
    return new ChatScreenOldVersionState(order_uuid);
  }
}

class ChatScreenOldVersionState extends State<ChatScreenOldVersion> with WidgetsBindingObserver {
  List<ChatMessageScreen> chatMessageList;
  String order_uuid;

  ChatScreenOldVersionState(this.order_uuid);
