...
class MenuItemState extends State<MenuItem> with AutomaticKeepAliveClientMixin {
          ...
          Padding(
            ...
            child: Align(
                ...
                child: Column(
                  children: [
                    Text(
                      'К сожалению, заведение не доступно.',
                      style: TextStyle(fontSize: 16),
                      textAlign: TextAlign.center,
                    ),
                    Text(
                      (standard != null)
                          ? "Заведение откроется в ${standard.beginningTime} часов"
                          : '',
                      style: TextStyle(fontSize: 16),
                      textAlign: TextAlign.center,
                    ),
  ...
  Widget build(BuildContext context) {
    ...
    bool available = parent.restaurant.available.flag != null
        ? parent.restaurant.available.flag
        : true;
    super.build(context);
    ...
    if (parent.restaurant.type == 'restaurant') {
      return Container(
        color: AppColor.themeColor,
        child: Padding(
          padding: EdgeInsets.only(top: 15.0, left: 15, right: 15, bottom: 15),
          child: Center(
            child: Material(
              type: MaterialType.transparency,
              child: InkWell(
                splashColor: AppColor.unselectedBorderFieldColor,
                onTap: () async {
                    ...
                    children: <Widget>[
                      ...
                      Stack(
                        ...
                        children: [
                            ...
                            child: ClipRRect(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Image.network(
                                    getImage((restaurantDataItems.meta.images !=
                                            null)
                          ...
                          Visibility(
                            visible: restaurantDataItems.meta.oldPrice == 0
                                ? false
                                : true,
                            child: DiscountTapeWidget(
                              price: restaurantDataItems.price,
                              oldPrice: restaurantDataItems.meta.oldPrice,
                            ),
                          ),
                        ],
                      ),
                          ...
                          child: Align(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                    fontSize: 12.0, color: AppColor.textColor),
                                textAlign: TextAlign.start,
                              ),
                            ),
                          ),
                                                                  ...
                                                                  if (await Internet
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      variantsSelectors
                                                                        ...
                                                                        if (variantGroupSelector
                                                                          ...
                                                                          variantGroupSelector
                                                                              ...
                                                                              .currentState
                                                                              .setState(() {
                                                                            variantGroupSelector.key.currentState.error =
                                                                                true;
                                                                          });
                                                                        }
                                                                      });
                                                                      ...
                                                                      if (currentUser.cartModel != null &&
                                                                        ...
                                                                        print(productsDescription.product.storeUuid.toString() +
                                                                            "!=" +
                                                                            currentUser.cartModel.storeUuid.toString());
                                                                        ...
                                                                        if (parent.itemsPaddingKey.currentState !=
                                                                            null) {
                                                                          parent
                                                                              .itemsPaddingKey
                                                                              .currentState
                                                                        ...
                                                                        parent.showAlertDialog(
                                                                            context);
                                                                        if (parent.basketButtonStateKey.currentState !=
                                                                            null) {
                                                                          parent
