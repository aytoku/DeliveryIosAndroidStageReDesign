...
//    bool available = parent.restaurant.available != null ? parent.restaurant.available : true;
    ...
    if(restaurantDataItems.type == 'single'){
      ...
      showModalBottomSheet(
          ...
          builder: (context) {
            return Container(
              height: getBottomSheetHeight(restaurantDataItems),
              child: Align(
                alignment: Alignment.bottomCenter,
                child: Stack(
                  children: [
                    ...
                    Align(
                        alignment: Alignment.bottomCenter,
                        child: FutureBuilder<ProductsDataModel>(
                          ...
                          builder: (BuildContext context,
                            ...
                            if(snapshot.connectionState == ConnectionState.done){
                              ...
                              return Container(
                                height: getContainerHeight(restaurantDataItems),
                                decoration: BoxDecoration(
                                    color: Colors.white,
                                    borderRadius: BorderRadius.only(
                                      topLeft: const Radius.circular(12),
  ...
  double getBottomSheetHeight(ProductsByStoreUuid restaurantDataItems){
    return restaurantDataItems.name.length ~/ 18 + 500 * 1.0;
  }

  double getContainerHeight(ProductsByStoreUuid restaurantDataItems){
    return restaurantDataItems.name.length ~/ 18 + 200 * 1.0;
  }
}