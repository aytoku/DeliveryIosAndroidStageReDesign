                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            fontSize: 17, fontWeight: FontWeight.bold, color: AppColor.textColor),
                      ),
                    ),
                    Divider(
                      height: 1,
            ...
            child: Align(
                ...
                child: Row(
                  children: List.generate(restaurant.storeCategoriesUuid.length, (index){
                    return Text(restaurant.storeCategoriesUuid[index].name + ' ', style: TextStyle(color: AppColor.textColor),);
                  }),
                )
            ),
          )
    ...
    sliverScrollController.addListener(() async {
      ...
      if(sliverTextKey.currentState != null && sliverScrollController.offset > 89){
        sliverTextKey.currentState.setState(() {
          sliverTextKey.currentState.title =  new Text(this.restaurant.name, style: TextStyle(color: AppColor.textColor),);
        });
      }else{
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                child: Padding(
                                  ...
                                  child: SvgPicture.asset(
                                      'assets/svg_images/rest_info.svg', color: AppColor.textColor,),
                                ),
                                onTap: (){
                                  _restInfo();
                                },
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        SvgPicture.asset('assets/svg_images/star.svg', color: AppColor.textColor,
                                        ),
                                        Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Padding(
                                          ...
                                          child: SvgPicture.asset('assets/svg_images/rest_car.svg', color: AppColor.textColor
                                          ),
                                        ),
                                        Text(
                                          '~' +  '${restaurant.meta.avgDeliveryTime}',
