                          ...
                          child: GestureDetector(
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color: (selectedPageId == 0) ? AppColor.mainColor : AppColor.fieldColor,
                              ),
                              child: Center(
                                child: Text(
                                  'Доставка',
                                  style: TextStyle(
                                      color: (selectedPageId == 0) ? AppColor.textColor : AppColor.textColor, fontSize: 15),
                                ),
                              ),
                            ),
                            onTap: () async {
                          ...
                          child: GestureDetector(
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color: (selectedPageId == 1) ? AppColor.mainColor : AppColor.fieldColor,
                              ),
                              child: Center(
                                child: Text(
                                  'Самовывоз',
                                  style: TextStyle(
                                      color: (selectedPageId == 1) ? AppColor.textColor : AppColor.textColor, fontSize: 15),
                                ),
                              ),
                            ),
                            onTap: () async {
